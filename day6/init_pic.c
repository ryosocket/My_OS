...
void init_pic(void)
{
    ...
    io_out8(PIC0_ICW4,0x01); /*ノンバッファモードモード*/

    io_out8(PIC0_IMR,0xfb); /*11111011 PIC1以外は全て禁止*/
    io_out8(PIC0_IMR,0xff); /*11111111 全ての割り込みを受け付けない*/
}
...
void inthandler21(int *esp)
{
    ...
    putfont8_asc(binfo->vram,binfo->scrnx,0,0,COL8_C6C6C6,"INT 21 (IRQ-1): PS/2 keyboard");
    for (;;)
    {
        io_hlt();
    }
